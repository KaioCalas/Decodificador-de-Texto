function executar(modo) {
  ...
  pTituloResultado.classList.add('p-result-title')
  ...
  textAreaResultado.classList.add('result-textarea')
  ...
  if (verificaTexto.test(texto)) {
    ...
    areaResultado.appendChild(imgResultado)
    pTituloResultado.textContent =
      'Por favor, utilize somente letras minúsculas e sem acento!'
    areaResultado.appendChild(pTituloResultado)
  }
}
...
function descriptografar(texto) {
  ...
  if (
    !descriptografar.includes('ai') &&
    !descriptografar.includes('enter') &&
    !descriptografar.includes('imes') &&
    !descriptografar.includes('ober') &&
    !descriptografar.includes('ufat')
  ) {
...
function copiarTexto() {
  var texto = document.querySelector('.result-textarea')
  texto.select()
